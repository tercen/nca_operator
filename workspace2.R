...
options("tercen.workflowId"= "6d478d8b1b3c0783f44e1fa4aa00a68e")
options("tercen.stepId"= "270-40")
...
dose = 100
R2ADJ = 0.7
pk <-PK::nca(d$.x,d$.y, dose = dose, concUnit="mg/mL",iAUC=iAUC, down = "Log", R2ADJ = R2ADJ)
